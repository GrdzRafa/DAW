			...
			<div class="activities">
				...
				<div class="left-bottom">
					...
					<div class="personal-bests">
						<h1>Pràctica E07 - Buscar una cadena</h1>
						<div class="practica-desc">
							<p>Defineix una funció que rebi per paràmetre un text i una cadena per per paràmetre. i em retorni el número d'aparicions d'aquesta cadena al text.</p>
							<p>Fer una altra funció que em retorni les posicions on comença aquesta cadena dins el text.</p>
							<a href="./activityE07sol.php">
								<button class="btn">Veure solució</button>
							</a>
						</div>
					</div>
				</div>
