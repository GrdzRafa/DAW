			...
			<div class="activities">
				...
				<div class="left-bottom">
					...
					<div class="personal-bests">
						<h1>Pràctica E04 - Calcula l'edat</h1>
						<div class="practica-desc">
							<p>Un càlcul molt sol·licitat en moltes ocasions és el de calcular l'edat. És un càlcul senzill una vegada tens en compte alguns factors imprescindibles.</p>
							</p>Si has nascut en 1990 i estem en el 2020 tindries 30 anys, sempre que hagis sobrepassat el dia i el mes del teu naixement. Sabent això generarem dos if que restessin un any en el cas de no complir amb la condició.</p>
							<br/><br/>
							
<pre style="font-size:1.0rem;">
<code style="color:red;">&lt;?php</code>
$dataDeNaixement = date_parse("26-09-2000");
$dataActual = getdate();

$anys = $dataActual['year'] - $dataDeNaixement['year'];

if ($dataActual['mon'] < $dataDeNaixement['month']) {
    $anys--;
} elseif ($dataActual['mon'] == $dataDeNaixement['month']) {
    if ($dataActual['mday'] > $dataDeNaixement['day'])  {
        $anys--;
    } 
}
echo "tens $anys anys";
